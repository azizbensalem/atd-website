...
(function ($) {
    $.fn.camera = function (opts, callback) {
        ...
        function thumbnailVisible() {
            ...
            $("li", thumbs).each(function () {
                var pos = $(this).position(),
                    ...
                    ulLeft = offDiv - offUl;
                if (ulLeft > 0) {
                    $(".camera_prevThumbs", camera_thumbs_wrap).removeClass(
                        "hideNav"
                    );
                } else {
                    $(".camera_prevThumbs", camera_thumbs_wrap).addClass(
                        "hideNav"
                    );
                }
                if (ulW - ulLeft > wTh) {
                    $(".camera_nextThumbs", camera_thumbs_wrap).removeClass(
                        "hideNav"
                    );
                } else {
                    $(".camera_nextThumbs", camera_thumbs_wrap).addClass(
                        "hideNav"
                    );
                }
                var left = pos.left,
        ...
        function resizeImage() {
            ...
            function resizeImageWork() {
                ...
                if (opts.height.indexOf("%") != -1) {
                    var startH = Math.round(
                        w / (100 / parseFloat(opts.height))
                    );
                    if (
                        opts.minHeight != "" &&
        ...
        function nextSlide(navSlide) {
            ...
            videoPresent = false;
            var vis = parseFloat(
                $("div.cameraSlide.cameracurrent", target).index()
            );
            ...
            if (!$(".imgLoaded", slide).length) {
                ...
                $.each(arr, function (index, value) {
                    ...
                    switch (fx) {
                        ...
                        case "blindCurtainTopRight":
                            (height = Math.floor(h / rows + addTop + 1)),
                                (width = 0),
                                (marginLeft =
                                    Math.floor(w / cols + addLeft + 1) + "px");
                            break;
                        case "blindCurtainBottomLeft":
                            (height = Math.floor(h / rows + addTop + 1)),
                                (width = 0),
                        ...
                        case "mosaicRandom":
                            ...
                            width = 0;
                            marginLeft =
                                Math.floor(w / cols + addLeft + 1) * 0.5 + "px";
                            marginTop =
                                Math.floor(h / rows + addTop + 1) * 0.5 + "px";
                            break;
                        case "mosaicSpiral":
                            height = 0;
                            width = 0;
                    ...
                    var easedTime =
                        parseFloat(transPeriod) + parseFloat(difference);
                        ...
                        if ($(".cameraeased", target).length == blocks) {
                            ...
                            if (lMoveIn != 0) {
                                $(
                                    ...
                                    if (
                                        typeof t.attr("data-outerHeight") ===
                                            "undefined" ||
                            ...
                            if (lMoveInContent != 0) {
                                $(
                                    ...
                                    if (tClass.indexOf("moveFromLeft") != -1) {
                                        ...
                                        tClass.indexOf("moveFromRight") != -1
                                    ) {
                                        t.css({
                                            left: w + "px",
                                            right: "auto",
                                        ...
                                        tClass.indexOf("moveFromBottom") != -1
                                    ) {
                                        t.css({
                                            top: h + "px",
                                            bottom: "auto",
                                        ...
                                        tClass.indexOf("fadeFromRight") != -1
                                    ) {
                                        t.animate({ opacity: 0 }, 0).css({
                                            left: w + "px",
                                            right: "auto",
                                        ...
                                        tClass.indexOf("fadeFromBottom") != -1
                                    ) {
                                        t.animate({ opacity: 0 }, 0).css({
                                            bottom: "-" + thisH + "px",
                                        });
