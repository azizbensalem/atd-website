    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Membre num {{$user->id}}</h4>
                ...
                <a href="/admin/admins/edit/{{$user->id}}" class="btn btn-success mr-2">Modifier</a>
                <a href="/admin/admins/newpassword/{{$user->id}}" class="btn btn-info mr-2">Changer le mot de passe</a>
                <a href="/admin/admins/" class="btn btn-light">Retour</a>
        </div>
    </div>
</div>
@endsection