        ...
        <div class="card-body">
            ...
            @csrf
                <div class="form-group">
                    <label>Titre</label>
                    <input type="text" class="form-control" name="title" value="{{$projects->title}}" placeholder="Ajouter le titre de l'article">
                </div>
                <div class="form-group">
                    <label>Texte</label>
                    <textarea class="form-control" name="description" rows="12"placeholder="Ajouter le texte de l'article">{{$projects->description}}</textarea>
                </div>
                <div class="form-group">
                    <label>Image</label>
