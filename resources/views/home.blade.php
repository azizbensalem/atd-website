		...
		<div class="main-page-wrapper">
			...
			<div class="about-compnay section-spacing">
				<div class="container">
					<div class="theme-title-one text-center">
						<h2 class="title">World Leading Consulting Firm</h2>
					</div> <!-- /.theme-title-one -->
					<div class="row">
									...
									<div class="row">
										<div class="col-md-6 col-12 wow fadeInUp animated">
											<div class="single-service">
												...
												<div class="srvc-name">
													<h6><a href="service-details.html">Business Consulting</a></h6>
										...
										<div class="col-md-6 col-12 wow fadeInUp animated">
											<div class="single-service">
												...
												<div class="srvc-name">
													<h6><a href="service-details.html">IT Consulting</a></h6>
													<span>We are Consulting Company</span>
												</div> <!-- /.srvc-name -->
												<p>Vitae laoreet sagittis. In pellentesqueviverra purus. Sed risus est, molhendrerit,Proactively envisioned multimedia </p>
											</div> <!-- /.single-service -->
										...
										<div class="col-md-6 col-12 wow fadeInUp animated">
											<div class="single-service">
												...
												<div class="srvc-name">
													<h6><a href="service-details.html">Lawyers Consulting</a></h6>
													<span>We are Consulting Company</span>
												</div> <!-- /.srvc-name -->
												<p>Vitae laoreet sagittis. In pellentesqueviverra purus. Sed risus est, molhendrerit,Proactively envisioned multimedia </p>
											</div> <!-- /.single-service -->
										...
										<div class="col-md-6 col-12 wow fadeInUp animated">
											<div class="single-service">
												...
												<div class="srvc-name">
													<h6><a href="service-details.html">Financial Consulting</a></h6>
													<span>We are Consulting Company</span>
												</div> <!-- /.srvc-name -->
												<p>Vitae laoreet sagittis. In pellentesqueviverra purus. Sed risus est, molhendrerit,Proactively envisioned multimedia </p>
											</div> <!-- /.single-service -->
			...
			<div class="theme-counter-two section-spacing">
				<div class="container">
					<div class="bg">
						<div class="theme-title-one text-center">
							<h2 class="title">Some fun facts about our consulting</h2>
						</div> <!-- /.theme-title-one -->
			...
			<footer class="theme-footer-one">
				...
				<div class="bottom-footer">
					<div class="container">
						<p>Copyright 2018 Negozu – All Right Reserved</p>
					</div>
				</div> <!-- /.bottom-footer -->
			</footer> <!-- /.theme-footer -->
